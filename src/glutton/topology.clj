...
https://github.com/nathanmarz/storm/wiki/Clojure-DSL"
  (:require [glutton
             ...
             [bolts :refer [stormy-bolt glutton-bolt sliding-count-bolt extract-hashtag-bolt count-agg-bolt]]
...
(defn stormy-topology []
  (topology
...

   {
    ...
    "sliding-count-bolt" (bolt-spec {"hashtag-bolt" ["hashtag"]} sliding-count-bolt :p 4)
    "count-agg-bolt" (bolt-spec {"sliding-count-bolt" :global} count-agg-bolt)
    }))
